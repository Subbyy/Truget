...
namespace Truget.Infrastructure.Library.Services
{
    public class EntityTranslatorService : IEntityTranslatorService
    {
        private static List<IEntityTranslator> _translators = new List<IEntityTranslator>();
        
        public static void RegisterEntityTranslator(IEntityTranslator translator)
        {
            if (translator == null)
        ...
        public static void RemoveEntityTranslator(IEntityTranslator translator)
        {
            if (translator == null)
                throw new ArgumentNullException("translator");
        ...
        public object Translate(Type targetType, object source)
        {
            ...
            else
            {
                ...
                if (translator != null)
                {
                    return translator.Translate(targetType, source);
                }
            }
